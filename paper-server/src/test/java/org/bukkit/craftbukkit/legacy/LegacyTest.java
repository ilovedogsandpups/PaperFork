...
public class LegacyTest {
    ...
    private final Set<Material> INVALIDATED_MATERIALS = new HashSet<>(Arrays.asList(Material.ACACIA_BUTTON, Material.ACACIA_PRESSURE_PLATE, Material.ACACIA_TRAPDOOR, Material.AIR, Material.ATTACHED_MELON_STEM, Material.ATTACHED_PUMPKIN_STEM,
            ...
            Material.SOUL_CAMPFIRE, Material.STRIDER_SPAWN_EGG, Material.WARPED_FUNGUS_ON_A_STICK, Material.ZOGLIN_SPAWN_EGG, Material.IRON_CHAIN, Material.MUSIC_DISC_PIGSTEP,
            // 1.16.2
            ...
            // 1.21.9
            Material.ACACIA_SHELF, Material.BAMBOO_SHELF, Material.BIRCH_SHELF, Material.CHERRY_SHELF, Material.COPPER_AXE, Material.COPPER_BARS, Material.COPPER_BOOTS, Material.COPPER_CHAIN, Material.COPPER_CHEST, Material.COPPER_CHESTPLATE, Material.COPPER_GOLEM_SPAWN_EGG,
            Material.COPPER_GOLEM_STATUE, Material.COPPER_HELMET, Material.COPPER_HOE, Material.COPPER_HORSE_ARMOR, Material.COPPER_LANTERN, Material.COPPER_LEGGINGS, Material.COPPER_NUGGET, Material.COPPER_PICKAXE, Material.COPPER_SHOVEL, Material.COPPER_SWORD,
            Material.COPPER_TORCH, Material.COPPER_WALL_TORCH, Material.CRIMSON_SHELF, Material.DARK_OAK_SHELF, Material.EXPOSED_COPPER_BARS, Material.EXPOSED_COPPER_CHAIN, Material.EXPOSED_COPPER_CHEST, Material.EXPOSED_COPPER_GOLEM_STATUE, Material.EXPOSED_COPPER_LANTERN,
            Material.EXPOSED_LIGHTNING_ROD, Material.JUNGLE_SHELF, Material.MANGROVE_SHELF, Material.OAK_SHELF, Material.OXIDIZED_COPPER_BARS, Material.OXIDIZED_COPPER_CHAIN, Material.OXIDIZED_COPPER_CHEST, Material.OXIDIZED_COPPER_GOLEM_STATUE, Material.OXIDIZED_COPPER_LANTERN,
            Material.OXIDIZED_LIGHTNING_ROD, Material.PALE_OAK_SHELF, Material.SPRUCE_SHELF, Material.WARPED_SHELF, Material.WAXED_COPPER_BARS, Material.WAXED_COPPER_CHAIN, Material.WAXED_COPPER_CHEST, Material.WAXED_COPPER_GOLEM_STATUE, Material.WAXED_COPPER_LANTERN,
            Material.WAXED_EXPOSED_COPPER_BARS, Material.WAXED_EXPOSED_COPPER_CHAIN, Material.WAXED_EXPOSED_COPPER_CHEST, Material.WAXED_EXPOSED_COPPER_GOLEM_STATUE, Material.WAXED_EXPOSED_COPPER_LANTERN, Material.WAXED_EXPOSED_LIGHTNING_ROD, Material.WAXED_LIGHTNING_ROD,
            ...
            // 26.2
            Material.CHISELED_CINNABAR, Material.CHISELED_SULFUR, Material.CINNABAR, Material.CINNABAR_BRICKS, Material.CINNABAR_BRICK_SLAB, Material.CINNABAR_BRICK_STAIRS, Material.CINNABAR_BRICK_WALL, Material.CINNABAR_SLAB, Material.CINNABAR_STAIRS, Material.CINNABAR_WALL,
            Material.MUSIC_DISC_BOUNCE, Material.POLISHED_CINNABAR, Material.POLISHED_CINNABAR_SLAB, Material.POLISHED_CINNABAR_STAIRS, Material.POLISHED_CINNABAR_WALL, Material.POLISHED_SULFUR, Material.POLISHED_SULFUR_SLAB, Material.POLISHED_SULFUR_STAIRS, Material.POLISHED_SULFUR_WALL,
            Material.POTENT_SULFUR, Material.SULFUR, Material.SULFUR_BRICKS, Material.SULFUR_BRICK_SLAB, Material.SULFUR_BRICK_STAIRS, Material.SULFUR_BRICK_WALL, Material.SULFUR_CUBE_BUCKET, Material.SULFUR_CUBE_SPAWN_EGG, Material.SULFUR_SLAB, Material.SULFUR_SPIKE, Material.SULFUR_STAIRS,
            Material.SULFUR_WALL,
            //
    ...
    public void toLegacyMaterial() {
        for (Material material : Material.values()) {
            if (!this.INVALIDATED_MATERIALS.contains(material) && !material.isLegacy()) {
                MaterialData converted = org.bukkit.craftbukkit.craftOthers.legacy.CraftLegacy.toLegacyData(material);
                ...
                if (!this.INVALIDATED_MATERIALS.contains(converted.getItemType())) {
                    assertNotEquals(Material.AIR, org.bukkit.craftbukkit.craftOthers.legacy.CraftLegacy.fromLegacy(converted), "Could not fromLegacy(toLegacy) " + converted + "(" + material + ")");
                }
                if (!this.INVERSION_FAILS.contains(material)) {
                    assertEquals(material, org.bukkit.craftbukkit.craftOthers.legacy.CraftLegacy.fromLegacy(converted), "Could not fromLegacy(toLegacy) " + converted + "(" + material + ")");
                }
            }
        }

        assertEquals(Material.LEGACY_AIR, org.bukkit.craftbukkit.craftOthers.legacy.CraftLegacy.toLegacy(Material.AIR), "Could not toLegacy Air");
    }
    ...
    public void fromLegacyMaterial() {
        for (Material material : Material.values()) {
            if (!this.INVALIDATED_MATERIALS.contains(material) && material.isLegacy()) {
                Material converted = org.bukkit.craftbukkit.craftOthers.legacy.CraftLegacy.fromLegacy(material);
                assertNotEquals(Material.AIR, converted, "Could not fromLegacy " + material);

                assertNotEquals(Material.AIR, org.bukkit.craftbukkit.craftOthers.legacy.CraftLegacy.toLegacy(converted), "Could not toLegacy(fromLegacy) " + converted + "(" + material + ")");
                if (!this.INVERSION_FAILS.contains(material)) {
                    assertEquals(material, org.bukkit.craftbukkit.craftOthers.legacy.CraftLegacy.toLegacy(converted), "Could not toLegacy(fromLegacy) " + converted + "(" + material + ")");
                }
            }
        }

        assertEquals(Material.AIR, org.bukkit.craftbukkit.craftOthers.legacy.CraftLegacy.fromLegacy(Material.LEGACY_AIR), "Could not fromLegacy Air");
    }

    @Test
    public void testRestricted() {
        for (Material material : org.bukkit.craftbukkit.craftOthers.legacy.CraftLegacy.values()) {
