...
public final class CraftLegacy {
    ...
    public static Material fromLegacy(Material material) {
        ...
        return org.bukkit.craftbukkit.craftUtils.legacy.CraftLegacy.fromLegacy(material);
    }

    public static Material fromLegacy(MaterialData materialData) {
        return org.bukkit.craftbukkit.craftUtils.legacy.CraftLegacy.fromLegacy(materialData);
    }
