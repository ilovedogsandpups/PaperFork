...
public class CraftCreatureSpawner extends CraftBlockEntityState<SpawnerBlockEntity> implements CreatureSpawner, PaperSharedSpawnerLogic { // Paper - more spawner API
