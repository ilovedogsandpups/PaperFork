...
public record ActionButtonImpl(Component label, @Nullable Component tooltip, int width, @Nullable DialogAction action) implements ActionButton {
    ...
    public static final class BuilderImpl implements ActionButton.Builder {
        ...
        @Override
        public @NonNull Builder tooltip(final @Nullable Component tooltip) {
            this.tooltip = tooltip;
            return this;
        }

        @Override
        public @NonNull Builder width(final @Range(from = 1, to = 1024) int width) {
            this.width = requireRange(width, "width", 1, 1024);
            return this;
        }

        @Override
        public @NonNull Builder action(final @Nullable DialogAction action) {
            this.action = action;
            return this;
        }

        @Override
        public @NonNull ActionButton build() {
